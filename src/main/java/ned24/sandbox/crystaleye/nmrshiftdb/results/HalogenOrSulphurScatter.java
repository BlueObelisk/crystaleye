...
public class HalogenOrSulphurScatter extends ShiftPlot {
	
	private HalogenOrSulphurScatter() {
		;
	}
	
	public HalogenOrSulphurScatter(List<File> fileList, String protocolName, String folderName, String htmlTitle) {
	...
	public static void main(String[] args) {
		...
		String folderName = "halogensAndS";
		...
		HalogenOrSulphurScatter c = new HalogenOrSulphurScatter(fileList, protocolName, folderName, htmlTitle);
		c.run();
	}
}

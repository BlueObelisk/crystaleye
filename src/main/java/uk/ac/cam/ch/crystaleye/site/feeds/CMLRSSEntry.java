...
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.DC_NS;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.RDF_NS;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.RSS_1_NS;
...
public class CMLRSSEntry implements CMLConstants {
	...
	public Element createAtom1Entry() {
		...
		Node node = IOUtils.parseXmlFile(cmlFilePath).getRootElement();
	...
	public Element createRss2Entry() {					
		...
		Element element = IOUtils.parseXmlFile(cmlFilePath).getRootElement();

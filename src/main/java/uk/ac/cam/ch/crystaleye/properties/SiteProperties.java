...
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.ATOM_PUB_FEED_MAX_ENTRIES;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.ATOM_PUB_ROOT_DIR;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.ATOM_PUB_ROOT_URL;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.BOND_LENGTHS_DIR;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.CELL_PARAMS_FILE;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.DOI_LIST_PATH;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.RSS_FEED_TYPES;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.RSS_ROOT_FEEDS_DIR;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.RSS_WRITE_DIR;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.SMILES_INDEX_PATH;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.SMILES_LIST_PATH;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.SUMMARY_WRITE_DIR;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.UUID_TO_URL_FILE_PATH;
import static uk.ac.cam.ch.crystaleye.CrystalEyeConstants.WEB_SUMMARY_WRITE_DIR;

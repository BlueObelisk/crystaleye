package uk.ac.cam.ch.crystaleye.templates.webpages;
...
public class CifSummaryToc {
	...
	public String getWebpage() {
		...
		if (levelsBelowJmolApplet == 0) {
			...
			throw new CrystalEyeRuntimeException("Webpage to be created must be below directory of Jmol applet - please supply levelsBelowJmolApplet as > 0.");
		}

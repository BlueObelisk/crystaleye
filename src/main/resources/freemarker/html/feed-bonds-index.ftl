			...
			<div id="main">
				<div id="contentcontainer">
					<div id="content">
						...
						<p>These feeds contain the latest published structures containing
							a bond between two particular atoms. Clicking on an element takes
							you to a page summarizing feeds of all bonds containing that
							element:</p>
						<ul class="normal">
							<#list atoms as atom>
